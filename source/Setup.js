...
export let deviceConfigurations = {
    ...
    intake: {
        name: "Gas Intake",
        abbrev: null,
        build: builders.arrow("#2277ff", "right"),
        fields: [
    ...
    exhaust: {
        name: "Exhaust",
        abbrev: null,
        build: builders.arrow("#ff3399", "right"),
        fields: [
    ...
    burner: {
        ...
        abbrev: "CC",
        build: builders.circle("orange", 20),
        fields: [
    ...
    gas_turbine: {
        name: "Gas Turbine",
        abbrev: "GT",
        build: builders.rhomboid("red", "right"),
        fields: [
    ...
    generator: {
        name: "Load",
        abbrev: "L",
        build: builders.circle("#33bb44", 20),
        fields: [
    ...
    heat_exchanger: {
        name: "Heat Exchanger",
        abbrev: "HE",
        build: builders.rectangle("#ed7612", 60, 50),
        fields: [
    ...
    intercooler: {
        name: "Intercooler",
        abbrev: "IC",
        build: builders.circle("#3245ed", 20),
        fields: [
    ...
    air_flow: {
        name: "Air Flow",
        build: builders.arrow("red", "right"),
        fields: [
    ...
    diffuser: {
        name: "Diffuser",
        abbrev: "D",
        build: builders.rhomboid("green", "right"),
        fields: [
    ...
    nozzle: {
        name: "Nozzle",
        abbrev: "N",
        build: builders.rhomboid("#8723be", "left"),
        fields: [
            new Field("pl", "Pressure Loss", 0.01, FieldType.UNIT, percentUnit),
            new Field("hl", "Heat Loss", 0.0, FieldType.UNIT_COMBO, units.w),
    ...
    boiler: {
        name: "Boiler",
        abbrev: "B",
        build: builders.rectangle("#8723be", 40, 60),
        fields: [
    ...
    steam_turbine: {
        name: "Steam Turbine",
        abbrev: "ST",
        build: builders.rhomboid("orange", "right"),
        fields: [
    ...
    condenser: {
        name: "Condenser",
        abbrev: "CD",
        build: builders.circle(new Paper.Color(0.2, 0.2, 0.5), 20),
        fields: [
            new Field("he", "Heat Extracted", null, FieldType.UNIT_COMBO, units.w),
            new Field("pl", "Pressure Loss", 0.03, FieldType.UNIT, percentUnit),
